...
class hzOCR(object):
    ...
    info_dic = {}
    def baiduKey(self):
        exce = load_workbook(r"C:\hzocr\baiduOCR.xlsx")
    ...
    def baiduOCR(self):
        imagepath = r"C:\hzocr\jkft.jpg"
        imagepath1 = r"C:\hzocr\jkft1.jpg"
        ...
        image_contrasted.save(imagepath1)
        im = self.get_file_content(imagepath1)
